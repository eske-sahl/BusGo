...
export const Register = () => {
    ...
    const handleRegister = async (e) => {
        ...
        // ← NEW: require license for drivers
        ...
        try {
            const response = await axios.post('http://localhost:3002/register', {
                ...
                Photo: photo || null,
                License_number: role === 'driver' ? licenseNumber.trim() : null  // ← NEW
            });
                ...
                <form onSubmit={handleRegister}>
                    <div className="inputs">
                        ...
                        <div className="input">
                            ...
                            <select className="input-field select-field" defaultValue="" onChange={(e) => setDesignation(e.target.value)}>
                        ...
                        <div className="input">
                            ...
                            <select className="input-field select-field" defaultValue="" required onChange={(e) => setRole(e.target.value)}>
                        ...
                        {/* ── LICENSE NUMBER — only shows when role = driver ── */}
                        {role === 'driver' && (
                            <div className="input" style={{
                                border: '2px solid #c9a96e',
                                background: '#fef9f0'
                            }}>
                                <img src={user_icon} alt="license-icon" className="icon" />
                                <input
                                    type="text"
                        ...
                        {role === 'driver' && (
                            <small style={{ color: '#92400e', fontSize: '0.78rem', paddingLeft: '0.5rem', marginTop: '-0.4rem' }}>
                                🔑 Bus owners use this to find and invite you. Keep it accurate.
                            </small>
                        )}
